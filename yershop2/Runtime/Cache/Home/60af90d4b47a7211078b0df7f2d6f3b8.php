...
<dd><a rel="nofollow"  href="<?php echo U('help/lists?pid=56');?>">公告</a></dd>
<dd><a rel="nofollow"  href="<?php echo U('help/lists?pid=70');?>">活动</a></dd>
</dl>
...
<div class="center_right" style="display: block;">
	...
	<span style="display: block;text-align:center;margin:20px 0 20px 37px;font-weight:bold;padding:10px;font-size:17px;"><?php echo ($info["title"]); ?></span>
 
<p class="create_time">
				 发表于 <?php echo (date('Y-m-d H:i',$info["create_time"])); ?></p>

<?php if(empty($info)): ?>aoh，暂无数据！（请到后台文章发布区添加，参数ismenu=2）<?php else: endif; ?>
  <div class="art_content" ><?php echo ($info["content"]); ?>
