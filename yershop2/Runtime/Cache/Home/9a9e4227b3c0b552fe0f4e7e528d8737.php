...
<div class="goodlist-main">
	  ...
	  <?php if(is_array($childlist)): $i = 0; $__LIST__ = $childlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><span> <a href="<?php echo U('Article/lists/?pid='.$vo['id']);?>"><?php echo ($vo["title"]); ?></a></span><?php endforeach; endif; else: echo "" ;endif; endif; ?>
	   ...
	   <ul class="brand-list">
	     <li>品牌:</li>
		  <li <?php if(($brandid) == ""): ?>class="active"<?php else: endif; ?>><a href="<?php echo U('Article/index',array(pid=>$category['id'],order=>1,'sort'=>$see,'start_price'=>$start_price,'end_price'=>$end_price));?>">全部</a></li>
		 <?php if(is_array($bdata)): $i = 0; $__LIST__ = $bdata;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if(($brandid) == $vo['id']): ?>class="active"<?php else: endif; ?>><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$vo['id'],order=>1,'sort'=>$see,'start_price'=>$start_price,'end_price'=>$end_price));?>" class="<?php echo ($value); ?>"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "暂时没有数据" ;endif; ?> </ul> 
 <ul class="brand-list">
	     <li>价格:</li>
  <li <?php if(($start_price) == ""): ?>class="active"<?php else: endif; ?>><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>$order,'sort'=>$see));?>" class="<?php echo ($value); ?>">全部</a></li>

		  <li <?php if(($start_price) == "0"): ?>class="active"<?php else: endif; ?>><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>$order,'sort'=>$see,start_price=>0,'end_price'=>100));?>" class="<?php echo ($value); ?>">0-100</a></li>
<li <?php if(($start_price) == "100"): ?>class="active"<?php else: endif; ?>><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>$order,'sort'=>$see,start_price=>100,'end_price'=>200));?>"">100-200</a></li>
<li <?php if(($start_price) == "200"): ?>class="active"<?php else: endif; ?>><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>$order,'sort'=>$see,start_price=>200,'end_price'=>300));?>"">200-300</a></li>
<li <?php if(($start_price) == "300"): ?>class="active"<?php else: endif; ?>><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>$order,'sort'=>$see,start_price=>300,'end_price'=>400));?>" class="<?php echo ($value); ?>">300-400</a></li>
<li <?php if(($start_price) == "400"): ?>class="active"<?php else: endif; ?>><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>1,'sort'=>$see,start_price=>400,'end_price'=>500));?>"class="<?php echo ($value); ?>">400-500</a></li>
<li <?php if(($start_price) == "500"): ?>class="active"<?php else: endif; ?>><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>$order,'sort'=>$see,start_price=>500));?>"class="<?php echo ($value); ?>">500以上</a></li>
		 </ul> 

       <ul class="ml_content_top"><li <?php if(($order) == "1"): ?>class="active"<?php else: endif; ?>><a rel="nofollow" href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>1,'sort'=>$see,'start_price'=>$start_price,'end_price'=>$end_price));?>
	   " class="<?php echo ($value); ?>">热度<i></i></a></li><li <?php if(($order) == "2"): ?>class="active"<?php else: endif; ?>><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>2,'sort'=>$see,'start_price'=>$start_price,'end_price'=>$end_price));?>
	   " class="<?php echo ($value); ?>">最新<i></i></a></li><li <?php if(($order) == "3"): ?>class="active"<?php else: endif; ?>><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>3,'sort'=>$see,'start_price'=>$start_price,'end_price'=>$end_price));?>
	   " class="<?php echo ($value); ?>">价格<i></i></a></li><li <?php if(($order) == "4"): ?>class="active"<?php else: endif; ?>><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>4,'sort'=>$see,'start_price'=>$start_price,'end_price'=>$end_price));?>
