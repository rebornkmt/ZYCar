...
.endtime{font-size:14px; font-family:"Microsoft Yahei"; color:#000}
                ...
                <ul> <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="li" onmouseover="this.className='lihover'" onmouseout="this.className='li'">
               <a href="<?php echo U('Article/detail?id='.$vo['id']);?>"><img src="<?php echo (get_cover($vo["cover_id"],'path')); ?>"> </a> 
               <p class="title"><?php echo ($vo["title"]); ?></p>
			    <p><span class="tuan"><strong>￥<?php echo ($vo["price"]); ?></strong></span><span class="qiang"><a>去预约</a></span></p>
		

 <div class="times">
       
        结束时间：<span class="endtime" "><?php echo (date('Y-m-d H:i',$vo["deadline"])); ?></span>
     </div>
