...
<p class=""><span class="quantity">数量：</span><span class="quantity-form"><a href="javascript:void(0)" class="jia"  onclick="add()" >+</a>  
  ...
  <?php if(!empty($info['parameters'])): ?><li class="weight pp_prop_wrap"><?php echo ($info["parameters"]); ?>： <?php if(!empty($info['parameters_value'])){ $datalist= explode('、',$info['parameters_value']);}else{ $datalist="";} ?>
