...
$(document).ready(function () {$(".order_namelist span").eq(0).addClass("active");
  ...
  })</script><?php if(empty($list)): ?><div class="personal_info_none_goods">
				<p>没有订单，<a href='<?php echo U("index/index");?>' class="red">快去下单吧</a></p>
			
				<div class="cb"></div>
			</div>
	<?php else: ?><form action='<?php echo U("order/del");?>' method="post" name="delform" >
        <div class="order_del">
	  ...
	  <span class="good-status">交易状态</span> <span class="deal-action">交易操作</span></div>
		...
		<?php if(($po['status']) > "2"): ?><b><a href="<?php echo U('order/del?tag='.$po['tag']);?>" ><img src="/yershop2/Public/Home/images/iconfont-lajixiang.png" width="20" height="20"></a></b><?php endif; ?>
			   </div>
         <!-- 列表详情区域开始 -->  
		...
		<!-- 左边商品区域开始 -->  
		 ...
		 <span class="dd"><?php echo ($vo["parameters"]); ?></span>
		  ...
		  <span class="c2">￥<?php echo ($vo["price"]); ?></span>
		  <span class="c2"><?php echo ($vo["num"]); ?></span> 
		    <span class="c2">  <?php if($vo['status']==1||$vo['status']==2){echo "无" ;}; if($vo['status']==3){echo "<a  href='index.php?s=/Home/back/index/id/".$vo['id']."'>退货</a>&nbsp;/"."<a  href='index.php?s=/Home/Exchange/index/id/".$vo['id']."'>换货</a>" ;}; if($vo['status']==4){echo "<a  href='index.php?s=/Home/back/detail/id/".$vo['id']."'>退货审核中</a>&nbsp;";}; if($vo['status']==5){echo "<a  href='index.php?s=/Home/back/detail/id/".$vo['id']."'>同意退货</a>&nbsp;";}; if($vo['status']==6){echo "<a  href='index.php?s=/Home/back/detail/id/".$vo['id']."'>退货中</a>&nbsp;";}; if($vo['status']==7){echo "<a  href='index.php?s=/Home/back/detail/id/".$vo['id']."'>退货被拒绝</a>&nbsp;";}; if($vo['status']==8){echo "<a  href='index.php?s=/Home/back/detail/id/".$vo['id']."'>退货完成</a>&nbsp;";}; if($vo['status']==-4){echo "<a  href='index.php?s=/Home/Exchange/detail/id/".$vo['id']."'>换货审核中</a>&nbsp;";}; if($vo['status']==-5){echo "<a  href='index.php?s=/Home/Exchange/detail/id/".$vo['id']."'>同意换货</a>&nbsp;";}; if($vo['status']==-6){echo "<a  href='index.php?s=/Home/Exchange/detail/id/".$vo['id']."'>换货中</a>&nbsp;";}; if($vo['status']==-7){echo "<a  href='index.php?s=/Home/Exchange/detail/id/".$vo['id']."'>换货被拒绝</a>&nbsp;";}; if($vo['status']==-8){echo "<a  href='index.php?s=/Home/Exchange/detail/id/".$vo['id']."'>换货完成</a>&nbsp;";}; if($vo['iscomment']==1){echo "<br/><a  href='index.php?s=/Home/comment/index/id/".$vo['id']."'>评价商品</a>";}; if($vo['iscomment']==2){echo "<br/><a  href='index.php?s=/Home/comment/index/id/".$vo['id']."'>已评价</a>";}; ?></span>
		  </div><?php endforeach; endif; else: echo "" ;endif; ?> 
		  </div>
		  <!-- 左边商品结束 -->  
		  
		  
 <div class="total-area"><p>￥<?php echo ($po["total_money"]); ?></p><p>(运费￥<?php echo ($po["ship_price"]); ?>)</p> 
		    </div>
		     <div class="deal-area">
			<p class="red"> 
			...
			<p><a href="<?php echo U('order/detail?id='.$po['orderid']);?>" >订单详情</a></p>
			   ...
			   <div class="act-area"> 
			   <?php $status=$po['status']; if($status==2){ echo " <p><a class=' confirm' href='index.php?s=/Home/order/complete/id/".$po['orderid']."'>确认收货</a> </p>"; }; $pay=$po['ispay']; if($pay==1&&$po['status']==-1){ echo " <p><A href='index.php?s=/Home/cancel/index/id/".$po['orderid']."'>取消订单</a>&nbsp; &nbsp;&nbsp; &nbsp; </p>"." <p><A class='confirm' href='index.php?s=/Home/Pay/index/orderid/".$po['orderid']."'>前去支付</a> </p>"; }; if($pay==-1&&$po['status']==1 ){ echo " <p><A  href='index.php?s=/Home/cancel/index/id/".$po['orderid']."'>取消订单</a> </p>"; } ; if($po['status']==2){ echo " <p><A class='red' href='index.php?s=/Home/order/detail/id/".$po['orderid']."'>查看物流</a> </p>"; } ?>
