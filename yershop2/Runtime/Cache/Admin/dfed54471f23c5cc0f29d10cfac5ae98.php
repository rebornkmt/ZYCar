...
<label class="item-label">
							菜单是否显示<span class="check-tips">（前台左侧主菜单是否显示）</span>
						</label>
						<div class="controls">
							<label class="inline radio"><input type="radio" name="ismenu" value="1" checked>是</label>
							<label class="inline radio"><input type="radio" name="ismenu" value="0">否</label>
...
Think.setValue("ismenu", <?php echo ((isset($info["ismenu"]) && ($info["ismenu"] !== ""))?($info["ismenu"]):1); ?>);
