...
<body>
 ...
 <?php if(isset($cate_rows)): ?></div><?php endif; ?> 
	...
	<div class="main-title">
		<h2><?php echo isset($info['id'])?'编辑':'新增';?>首页推广图片</h2>
	</div>
	<div class="tab-wrap">
...
if(this.value==0){
					...
					<div class="form-item">
						...
						<div class="form-item" id='num'>
						<label class="item-label" >
							位置<span class="check-tips">（广告位置，整数）</span>
						</label>
						<div class="controls">
							<input type="text" name="place" class="text input-large" value="<?php echo ((isset($info["place"]) && ($info["place"] !== ""))?($info["place"]):'1'); ?>">
						</div>
					</div>
					<div class="form-item">
