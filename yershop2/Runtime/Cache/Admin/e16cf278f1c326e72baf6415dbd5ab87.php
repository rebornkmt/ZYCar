...
<script>
 ...
 <?php if(isset($cate_rows)): ?></div><?php endif; ?> 
	...
	<script type="text/javascript" src="/yershop2/Public/static/uploadify/jquery.uploadify.min.js"></script>
		<script type="text/javascript" src="/yershop2/Public/static/UploadImages.js"></script>
            ...
            <div class="form-item cf">
                    ...
                    <div class="controls">	
								<div class="controls">
									...
									<input type="hidden" name="cover_id" id="cover_id_cover_id" value="<?php echo ($data[$field['name']]); ?>"/>
...
<link href="/yershop2/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
<?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/yershop2/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>
<link href="/yershop2/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/yershop2/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="/yershop2/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
<script type="text/javascript">
