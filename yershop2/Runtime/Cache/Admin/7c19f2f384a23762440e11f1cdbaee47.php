...
<!-- 按钮工具栏 -->
	<div class="cf">
		...
		<a id="optimize" class="btn" href="<?php echo U('clear');?>">清空日志</a>
		</div>
		...
		<div class="search-form fr cf">
			<div class="sleft">
				...
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('UserLog/index','&cate_id='.$cate_id,false);?>"><i class="btn-search"></i></a>
			</div>
			...
			<tbody>
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					<td><input class="ids row-selected" type="checkbox" name="id[]" value="<?php echo ($vo["id"]); ?>"></td>
                        ...
                        <td><?php echo (get_nickname($vo["uid"])); ?></td>
