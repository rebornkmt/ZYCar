...
<body>
 ...
 <?php if(isset($cate_rows)): ?></div><?php endif; ?> 
	...
	<div class="main-title">
		<h2><?php echo ($meta_title); ?>[ <strong>全部数量</strong>(<?php echo get_Ordernum($status,'cancel'); ?>)]</h2>
	</div>
<!-- 按钮工具栏 -->
	<div class="cf">
		<div class="fl">
		...
		<div class="search-form fr cf">
			<div class="sleft">
				<div class="drop-down">
					<span id="sch-sort-txt" class="sort-txt" data="<?php echo ($status); ?>"><?php if(get_status_title_bymodel($status,'cancel') == ''): ?>所有<?php else: echo get_status_title_bymodel($status,'cancel'); endif; ?></span>
					<i class="arrow arrow-down"></i>
					<ul id="sub-sch-menu" class="nav-list hidden">
					
						<li><a href="javascript:;" value="1">已提交</a></li>
						<li><a href="javascript:;" value="3">已同意</a></li>
				...
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('cancel/index','&cate_id='.$cate_id,false);?>"><i class="btn-search"></i></a>
			</div>
		 ...
		 <table>
			...
			<tbody>
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order): $mod = ($i % 2 );++$i;?><tr>
					...
					<td> 
                             <?php if(($status) == "1"): ?><a title="编辑" href="<?php echo U('edit?id='.$vo['id']);?>">编辑</a>
                            <a title="同意" href="<?php echo U('agree?id='.$vo['id']);?>">同意</a>
                            <a title="拒绝" href="<?php echo U('refuse?id='.$vo['id']);?>">拒绝</a>  
							<a class="confirm ajax-get" title="删除" href="<?php echo U('del?id='.$vo['id']);?>">删除</a><?php endif; ?>
  <?php if(($status) == "2"): ?><a title="编辑" href="<?php echo U('edit?id='.$vo['id']);?>">编辑</a>
                          <a title="同意" class="confirm ajax-get" href="<?php echo U('complete              ?id='.$vo['id']);?>">同意</a>
							<a class="confirm ajax-get" title="删除" href="<?php echo U('del?id='.$vo['id']);?>">删除</a><?php endif; ?>
  <?php if(($status) == "3"): ?><a title="编辑" href="<?php echo U('edit?id='.$vo['id']);?>">编辑</a>
