...
function safe_check($string) {
    if(is_array($string))	
     ...
     if(false!==strpos(strtolower($string),"in"))
        {
		//$this->error("非法字符in");
		 return false;
		  }
     else if(false!==strpos(strtolower($string),"between")){
			//echo "非法字符between";
          return false;
		}	
	   else {	
...
function safe_replace($string) {
	...
	if(false!==strpos(strtolower($string),"in")){
	   $string = str_replace('in','',strtolower($string));
	}
    if(false!==strpos(strtolower($string),"between")){
	   $string = str_replace('between','',strtolower($string));
	}		
	return $string;
}
function is_login(){
